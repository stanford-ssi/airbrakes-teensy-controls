...
static constexpr float CD_TABLE[MACH_COUNT][ANGLE_COUNT] = {
    ...
    {0.515247f, 0.563106f, 0.611684f, 0.660808f, 0.710313f, 0.760075f, 0.810038f, 0.860240f, 0.910821f, 0.962016f, 1.014138f, 1.067553f, 1.122667f, 1.179923f, 1.240688f, 1.306999f, 1.376232f, 1.447769f, 1.521340f, 1.596758f, 1.673869f, 1.752532f, 1.832599f, 1.913910f, 1.996290f},
...
float CdLookup::angleDegToServoPct(float angle_deg) {
    // Linear mapping: 1deg -> SERVO_MIN_PCT, 95deg -> SERVO_MAX_PCT
